...
_SK = {
    ...
    "renewal_labels": {"pzp": "PZP", "havarijne": "Havarijné poistenie",
                       "stk": "STK", "ek": "Emisná kontrola", "znamka": "Diaľničná známka",
                       "poistka": "Poistka",
...
_CS = {
    ...
    "renewal_labels": {"pzp": "Povinné ručení", "havarijne": "Havarijní pojištění",
                       "stk": "STK", "ek": "Emisní kontrola", "znamka": "Dálniční známka",
                       "poistka": "Pojistka",
...
_EN = {
    ...
    "renewal_labels": {"pzp": "Motor liability insurance",
                       ...
                       "stk": "Vehicle inspection (MOT)", "znamka": "Highway vignette",
