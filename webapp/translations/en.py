...
APP = {
    ...
    "mb_step_1": "Enter your login email and mailbox password.",
    "mb_step_2": "We fill in the server from your address — nothing technical to set.",
    "mb_step_3": "Click “Verify and connect” — we test the connection instantly.",
    "mb_where": "Provider (optional)",
    "mb_where_hint": "Pick one only if we didn't fill in the server for you, or if "
    ...
    "mb_guess_hint": "We guessed the server from your domain. If it doesn't "
                     "connect, adjust it under “Server settings”.",
